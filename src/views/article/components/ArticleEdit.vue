...
<template>
  <el-drawer v-model="visibleDrawer" :title="formModel.id ? '修改违约信息' : '增加违约信息'" direction="rtl" size="50%">
    <el-form :model="formModel" ref="formRef" label-width="100px">
      <el-form-item label="违约企业" prop="title">
        <el-input v-model="formModel.title" placeholder="请输入标题"></el-input>
      </el-form-item>
      <el-form-item label="违约类型" prop="cate_id">
        <channel-select v-model="formModel.cate_id" width="100%"></channel-select>
      </el-form-item>
      <el-form-item label="文件证明" prop="cover_img">
      ...
      <el-form-item label="违约具体内容" prop="content">
        <div class="editor">
      ...
      <el-form-item>
        <el-button @click="onPublish('已发布')" type="primary">违约</el-button>
        <el-button @click="onPublish('草稿')" type="info">重生</el-button>
      </el-form-item>
    </el-form>
